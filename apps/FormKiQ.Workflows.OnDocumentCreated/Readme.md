...
Execute unit tests
```
cd "FormKiQ.Workflows.Functions.DocumentCreated/test/FormKiQ.Workflows.Functions.DocumentCreated.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "FormKiQ.Workflows.Functions.DocumentCreated/src/FormKiQ.Workflows.Functions.DocumentCreated"
